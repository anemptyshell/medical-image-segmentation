...
python main.py --dataset CHASE_DB1 --epochs 200 --phase train --img_size 256 --model_name unet1221 --batch_size 2 --lr 0.0085 --print_interval 1 --save_interval 1 --output_end w_avg
python main.py --dataset CHASE_DB1 --epochs 200 --phase test --img_size 256 --model_name unet1221 --batch_size 2 --lr 0.0085 --print_interval 1 --save_interval 1 --output_end w_avg
