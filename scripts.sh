...
python main.py --dataset CHASE_DB1 --epochs 200 --phase train --img_size 256 --model_name unet3_resnet --batch_size 2 --lr 0.005 --print_interval 1 --save_interval 1
python main.py --dataset DRIVE --epochs 200 --phase train --img_size 256 --model_name unet3_resnet --batch_size 2 --lr 0.005 --print_interval 1 --save_interval 1
python main.py --dataset STARE --epochs 200 --phase train --img_size 256 --model_name unet3_resnet --batch_size 2 --lr 0.005 --print_interval 1 --save_interval 1