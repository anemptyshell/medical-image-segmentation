...
import math
from Med_image_seg.dconnnet.model_util.attention import CAM_Module,PAM_Module
# from model_util.attention import CAM_Module,PAM_Module
from Med_image_seg.dconnnet.model_util.resnet import resnet34
# from model_util.resnet import resnet34
import Med_image_seg.dconnnet.model_util.gap as gap
# import model_util.gap as gap
...
#    input = torch.rand(4, 3, 512, 512).to('cuda')
#    output1, output2 = model.forward(input)
#    # print('------------------')
#    print('output.size()')
#    print(output1.size())
#    print(output2.size())
