...
# from Med_image_seg.transunet.network import U_Net
from Med_image_seg.fang.utils.cldice import clDice
# from Med_image_seg.transunet.vit_seg_modeling import CONFIGS as CONFIGS_ViT_seg
from Med_image_seg.swinunet.config import get_config
from Med_image_seg.swinunet.vision_transformer import SwinUnet as ViT_seg
...
def arguments():
    ...
    '--vit_patches_size': 16,
    '--cfg': '/home/my/mis-ft/medical-image-segmentation/Med_image_seg/swinunet/your_config.yaml'
}  
    return args


class swinunet(base_model):
    def __init__(self, parser):
        ...
        # config_vit = CONFIGS_ViT_seg[self.args.vit_name]
        # if self.args.vit_name.find('R50') != -1:
        #     config_vit.patches.grid = (int(self.args.img_size / self.args.vit_patches_size), int(self.args.img_size / self.args.vit_patches_size))
        self.network = ViT_seg(config, img_size=self.args.img_size, num_classes=1).to('cuda')
