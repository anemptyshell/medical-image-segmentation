...
class Down1(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # print('scale1:', scale1_1.size())   # scale1: torch.Size([1, 64, 512, 512])
        scale1_2 = self.nn2(scale1_1)
        # print('scale2:', scale1_2.size())   # scale2: torch.Size([1, 64, 512, 512])

        unpooled_shape = scale1_2.size()
        outputs, indices = self.patch_embed(scale1_2)
        # print('output:', outputs.size())    # output: torch.Size([1, 64, 256, 256])
...
class Down1_new(nn.Module):

    def __init__(self):
        super(Down1_new, self).__init__()
        self.nn1 = ConvRelu(3, 64)
        self.nn2 = Trans_EB(64, 64)
...
class Down2_new(nn.Module):

    def __init__(self):
        super(Down2_new, self).__init__()
        self.nn1 = Trans_EB(64, 128) 
        self.nn2 = Trans_EB(128, 128)
...
class Down3_new(nn.Module):

    def __init__(self):
        super(Down3_new, self).__init__()
...
class Down4_new(nn.Module):

    def __init__(self):
        super(Down4_new, self).__init__()
...
class Down5_new(nn.Module):

    def __init__(self):
        super(Down5_new, self).__init__()

        # self.nn1 = Trans_EB(512, 512)
        # self.nn2 = Trans_EB(512, 512)
        # self.nn3 = Trans_EB(512, 512)

        self.nn1 = Trans_EB(512, 1024)
        self.nn2 = Trans_EB(1024, 1024)
        # self.nn3 = Trans_EB(1024, 1024)
