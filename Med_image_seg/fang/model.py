...
from Med_image_seg.fang.utils.loss import BceDiceLoss, soft_iou_loss #, bce_ssim_loss, bceioussim_loss

from Med_image_seg.fang.network import UNet_3de_iigi_hidi#,UNet_3de_emi#UNet_3decoder_hidi#UNet_Multi_decoder#UNet_2de#UNet_3de_sfd# UNet_3de_emi_hidi #UNet_3decoder_hidi  UNet_3decoder_hidi #UNet_Multi_decoder_fusion#Rolling_Unet_L #PUnet
...
class fang(base_model):
    def __init__(self, parser):
        ...
        self.network = UNet_3de_iigi_hidi().to('cuda')
        # self.network = PUnet().to('cuda')
        # self.network = Rolling_Unet_L(num_classes=1, img_size=self.args.img_size).to('cuda')
        # self.network = UNet_Multi_decoder_fusion().to('cuda')
        # self.network = UNet_3decoder_enhance().to('cuda')
        # self.network = UNet_2de().to('cuda')
        # self.network = UNet_res_3de().to('cuda')
        # self.network = UNet_3de_emi_hidi().to('cuda')
        # self.network = UNet_3de_sfd().to('cuda')
    ...
    def train_epoch(self, train_loader, epoch, step):
        ...
        for iter, data in enumerate(train_loader):
            ...
            loss4 = self.loss_iou(pred_raw, targets)
            ...
            # loss = loss1 + 0.33*loss2 + 0.33*loss3 + 0.33*loss_mi
