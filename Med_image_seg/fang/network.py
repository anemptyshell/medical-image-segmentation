...
from model_util.IIGI import Interaction
...
"""unet + 3de + IIGI + hidi"""
class UNet_3de_iigi_hidi(nn.Module):
    def __init__(self, input_ch=3, output_ch=1):
        super(UNet_3de_iigi_hidi, self).__init__()
        ...
        self.interaction1 = Interaction(in_channels=512, out_channels=512)
        self.interaction2 = Interaction(in_channels=256, out_channels=256)
        self.interaction3 = Interaction(in_channels=128, out_channels=128)
        self.interaction4 = Interaction(in_channels=64, out_channels=64)
    ...
    def forward(self, x):
        ...
        out= self.interaction1([d5_1, d5_2, d5_3])
        d5_1, d5_2, d5_3 = out[0], out[1], out[2]
        ...
        out= self.interaction2([d4_1, d4_2, d4_3])
        d4_1, d4_2, d4_3 = out[0], out[1], out[2]
        ...
        out= self.interaction3([d3_1, d3_2, d3_3])
        d3_1, d3_2, d3_3 = out[0], out[1], out[2]
        ...
        out= self.interaction4([d2_1, d2_2, d2_3])
        d2_1, d2_2, d2_3 = out[0], out[1], out[2]
