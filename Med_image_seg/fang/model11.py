...
from Med_image_seg.fang.network import UNet_Multi_decoder#UNet_2de#UNet_3de_sfd# UNet_3de_emi_hidi #UNet_3decoder_hidi  UNet_3decoder_hidi #UNet_Multi_decoder_fusion#Rolling_Unet_L #PUnet
...
class fang(base_model):
    def __init__(self, parser):
        ...
        self.network = UNet_Multi_decoder().to('cuda')
