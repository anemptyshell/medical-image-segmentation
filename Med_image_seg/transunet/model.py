...
from Med_image_seg.transunet.vit_seg_modeling import VisionTransformer as ViT_seg
...
class transunet(base_model):
    def __init__(self, parser):
        ...
        self.network = ViT_seg(config_vit, img_size=self.args.img_size, num_classes=1).to('cuda')
