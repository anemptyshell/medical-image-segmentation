...
#     model = Multi_decoder_Net(n_channels=3)
#     input = torch.rand(2, 3, 512, 512)
#     pred, pred_skeleton, pred_edge = model.forward(input)
#     print(pred.size())            ## torch.Size([2, 1, 512, 512])
#     print(pred_skeleton.size())   ## torch.Size([2, 1, 512, 512])
#     print(pred_edge.size())       ## torch.Size([2, 1, 512, 512])