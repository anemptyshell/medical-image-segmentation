...
from Med_image_seg.cgmanet.model_util.pvtv2 import pvt_v2_b2
# from model_util.pvtv2 import pvt_v2_b2
import torch
import torch.nn as nn
import torch.nn.functional as F
from Med_image_seg.cgmanet.model_util.net_util import SpatialAttention, ChannelAttention, PSPModule
# from model_util.net_util import SpatialAttention, ChannelAttention, PSPModule
...
# net = CGMA().to('cuda')
# a = torch.rand(4, 3, 512, 512).to('cuda')
...
# print(type(output[3]))
# print(type(output[4]))
# print(output[0].size())   # torch.Size([4, 1, 224, 224])
# print(output[1].size())
# print(output[2].size())
# print(output[3].size())
# print(output[4].size())
