...
from Med_image_seg.laplacianformer.loss import BceDiceLoss
from Med_image_seg.laplacianformer.network import LaplacianFormer
...
class laplacianformer(base_model):
    def __init__(self, parser):
        ...
        self.network = LaplacianFormer(self.args.num_classes).to('cuda')
        self.step = 0
        self.save_args()
