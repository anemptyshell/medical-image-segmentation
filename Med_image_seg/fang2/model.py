...
from Med_image_seg.fang2.network import UNet_3de_emi_hidi
import numpy as np
...
class fang2(base_model):
    ...
    def train_epoch(self, train_loader, epoch, step):
        ...
        for iter, data in enumerate(train_loader):
            ...
            pred_raw, pred_edge, pred_skeleton, preds, loss_mi = self.network(images)
            ...
            loss = loss1 + 0.33*loss2 + 0.33*loss3 + 0.33*loss4 + loss_mi       
